    ...
    <div className="space-y-6">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="bg-brand text-white px-6 py-2 rounded-none font-bold hover:bg-brand-dark transition-all flex items-center justify-center shadow-lg shadow-brand/10 active:scale-95 shrink-0 text-sm"
        >
          <BsPlusLg className="w-5 h-5 mr-2" /> 새 배너 등록
        </button>
      </header>
                ...
                <div className="flex items-center space-x-1.5">
                  {banner.isActive === 1 ? (
                    ...
                    <span className="flex items-center text-[9px] font-bold text-gray-400 bg-gray-50 px-2 py-0.5 rounded-none">
                      <BsXCircle className="w-4 h-4 mr-1.5" /> 비활성
                    </span>
                  )}
                </div>
              </div>
