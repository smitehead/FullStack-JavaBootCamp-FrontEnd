      ...
      <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex gap-4">
          <button
            ...
            className={`flex-1 p-6 rounded-3xl border-2 transition-all flex flex-col items-start text-left outline-none ${withdrawType === 'my' ? 'border-indigo-600 bg-indigo-50/50 shadow-none' : 'border-gray-100 bg-white hover:border-gray-200'}`}
          >
          ...
          <button
            ...
            className={`flex-1 p-6 rounded-3xl border-2 transition-all flex flex-col items-start text-left outline-none ${withdrawType === 'new' ? 'border-indigo-600 bg-indigo-50/50 shadow-none' : 'border-gray-100 bg-white hover:border-gray-200'}`}
          >
